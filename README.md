...
| `--http-controller-target` | Select the target framework for the controllers that you want to be generated.                                                              
|                            | CHOOSE ANY OF:                                                                                                                              
|                            | `SPRING` - Generates for the Spring framework. (Default)                                                                                    
|                            | `MICRONAUT` - Generate for the Micronaut framework. (experimental)                                                                          
